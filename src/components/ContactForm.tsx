  ...
  return (
    <section id="contact" className="py-16 sm:py-24 bg-card relative">
      ...
      <div className="container px-4">
        ...
        <div className="mx-auto grid max-w-5xl gap-8 lg:gap-12 lg:grid-cols-5">
          {/* Form — takes 3 cols */}
          <div className="lg:col-span-3">
            <div className="rounded-2xl border border-border bg-background p-5 sm:p-8 shadow-lg">
              {submitted ? (
                <div className="text-center py-6 sm:py-8 space-y-4 sm:space-y-5">
                  <div className="mx-auto w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-secondary/10 flex items-center justify-center">
                  ...
                  <div className="mt-5 sm:mt-6 pt-5 sm:pt-6 border-t border-border">
                    <p className="text-muted-foreground text-xs sm:text-sm mb-1">✨ Join our spiritual community ✨</p>
                    <p className="font-heading text-base sm:text-lg font-bold text-foreground mb-3 sm:mb-4">
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="mt-3 sm:mt-4 rounded-xl"
                  >
                    Book Another Puja
                  </Button>
                </div>
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 sm:space-y-5">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Enter your name" className="h-11 sm:h-12 rounded-xl" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Enter phone number" type="tel" className="h-11 sm:h-12 rounded-xl" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-foreground font-semibold text-sm">Service Required</FormLabel>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea placeholder="Any specific requirements or preferred dates..." className="rounded-xl min-h-[90px] sm:min-h-[100px]" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <Button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-secondary text-secondary-foreground hover:bg-secondary/90 font-bold h-11 sm:h-12 rounded-xl shadow-lg shadow-secondary/20 transition-all hover:shadow-xl hover:shadow-secondary/30"
                    size="lg"
                  >
          ...
          <div className="lg:col-span-2 space-y-4 sm:space-y-6">
            <div>
              <h3 className="font-heading text-lg sm:text-xl font-bold text-foreground mb-4 sm:mb-5">Call Us Directly</h3>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3 rounded-xl border border-secondary/20 bg-secondary/5 p-4 sm:p-5">
